...
<html lang="fr">
    ...
    <head>
        ...
        <title>Page de secrétaire</title>
        <style>
            body {
    ...
    <body>
        ...
        <form method="post" action="">
            <input type="submit" name="logout" id="logout" value="Déconnecter" class="logout-btn" />
        </form>
            ...
            <table class="demandes-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php $linkToOtherPage = "demandes.php?id=" . urlencode($id_etudiant); ?>
                            <a href="<?php echo $linkToOtherPage; ?>" class="btn btn-info">Plus</a>
                        </td>
                    </tr>
                    <?php 
                        endwhile;
